...
@section('content')
    <div class="container">
      ...
      Loopz S.A. informa acerca del uso de las cookies en su página web: www.loopz.cf
      <hr/>
      ...
      <ul>
        <li><b>Cookies propias</b>: aquéllas que se envían al equipo terminal del usuario desde un equipo o dominio gestionado
        por el propio editor y desde el que se presta el servicio solicitado por el usuario.</li>
        <li><b>Cookies de terceros</b>: aquéllas que se envían al equipo terminal del usuario desde un equipo o dominio que no es
        ...
        recoja mediante éstas sea gestionada por un tercero, no pueden ser consideradas como cookies propias.</li>
      </ul>
      ...
      <ul>
        <li><b>Cookies de sesión</b>: diseñadas para recabar y almacenar datos mientras el usuario accede a una página web. Se
        ...
        <li><b>Cookies persistentes</b>: los datos siguen almacenados en el terminal y pueden ser accedidos y tratados durante un
      ...
      <ul>
        <li><b>Cookies técnicas</b>: aquellas que permiten al usuario la navegación a través de una página web,
        ...
        <li><b>Cookies de personalización</b>: permiten al usuario acceder al servicio con algunas características de carácter
        ...
        servicio, etc.</li>
        <li><b>Cookies de análisis</b>: permiten al responsable de las mismas, el seguimiento y análisis del comportamiento de los
        ...
        <li><b>Cookies de publicidad comportamental</b>: almacenan información del comportamiento de los usuarios obtenida a
        ...
        <li><b>Cookies de redes sociales externas</b>: se utilizan para que los visitantes puedan interactuar con el contenido de
      ...
      <ul>
        <li><b>Microsoft Internet Explorer o Microsoft Edge</b>: http://windows.microsoft.com/es-es/windows-vista/Block-or-allow-cookies</li>
        <li><b>Mozilla Firefox</b>: http://support.mozilla.org/es/kb/impedir-que-los-sitios-web-guarden-sus-preferencia</li>
        <li><b>Chrome</b>: https://support.google.com/accounts/answer/61416?hl=es</li>
        <li><b>Safari</b>: http://safari.helpmax.net/es/privacidad-y-seguridad/como-gestionar-las-cookies/</li>
        <li><b>Opera</b>: http://help.opera.com/Linux/10.60/es-ES/cookies.html</li>
      </ul>
      <p>Además, también puede gestionar el almacén de cookies en su navegador a través de herramientas como las siguientes:</p>
      <ul>
        <li><b>Ghostery</b>: www.ghostery.com/</li>
        <li><b>Your online choices</b>: www.youronlinechoices.com/es/</li>
      </ul>
      <hr/>
      <h4>Cookies utilizadas en www.loopz.cf</h4>
      <p>A continuación se identifican las cookies que están siendo utilizadas en este portal así como su tipología y función:</p>
      <ul>
        <li><b>laravel_session</b>: Se utiliza para guardar la sesión del usuario.</li>
        <li><b>laravel_cookie_consent</b>: Almacena el consentimiento de uso de cookies.</li>
        <li><b>XSRF-TOKEN</b>: Se utiliza como medida de seguridad en los formularios.</li>
        <li><b>detalles</b>: Guarda la preferencia de "busqueda detallada" para usuarios no registrados.</li>
        <li><b>vistaprevia</b>: Guarda la preferencia de "vistas previas" para usuarios no registrados.</li>
        <li><b>remember_web_X</b>: Guarda la sesión del usuario en caso de marcar "Recuerdame".</li>

      </ul>
      <hr/>
      <h4>Aceptación de la Política de cookies</h4>
      <p>www.loopz.cf asume que usted acepta el uso de cookies. No obstante, muestra información sobre su Política de cookies en la parte
      ...
      <ul>
        <li><b>Aceptar cookies</b>: No se volverá a visualizar este aviso al acceder a cualquier página del portal durante la
        presente sesión.</li>
        <li><b>Cerrar</b>: Se oculta el aviso en la presente página.</li>
        <li><b>Modificar su configuración</b>: Podrá obtener más información sobre qué son las cookies, conocer la Política de
